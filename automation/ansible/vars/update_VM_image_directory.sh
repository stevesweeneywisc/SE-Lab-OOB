...
variable1="VM Disk Direcotry Location"
#   api_token_secret
#   api_host
#   storage
#   storage_name
...
Help()
{
  ...
  echo "$0 [$variable1]" 
  echo " " 
  echo "Example 1:  $0   /var/lib/vz        <= default:  storage 'on' PVE Server" 
  echo "Example 2:  $0   /mnt/pve/NFS-VMS   <= example of NAS NFS mount point" 
  echo " "
} 
